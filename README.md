...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/nadiacaricatto/blogpessoal_spring.git) dentro da pasta do *Workspace* do STS
...
Desenvolvido por [**Nádia Caricatto**](https://github.com/nadiacaricatto)
